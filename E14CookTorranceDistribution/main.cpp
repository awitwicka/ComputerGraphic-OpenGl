...
static CGparameter cg_vertex_param_ambient_light,
		   cg_vertex_param_light_color,
		   cg_vertex_param_light_position,
		   cg_vertex_param_camera_position,
                   cg_vertex_param_Ke,
                   cg_vertex_param_Ka,
                   cg_vertex_param_Kd,
                   cg_vertex_param_Ks,
                   cg_vertex_param_exponent;

#define GET_PARAM(name) cg_vertex_param_##name = cgGetNamedParameter(cg_vertex_program, #name); checkForCgError("getting parameter " #name);
